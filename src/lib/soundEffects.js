/**
 * Authentic osu! sound effects synthesizer using Web Audio API.
 * Provides snappy, tactile audio feedback on hover, clicks, and downloads
 * without needing external MP3 audio asset downloads.
 */
